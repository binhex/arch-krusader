...
pacman_packages="krusader p7zip unarj unzip unrar xz zip lhasa arj unace ntfs-3g kde-cli-tools kuiserver kdiff3 keditbookmarks kompare konsole krename ktexteditor breeze-icons"
